...
export default function VolunteerImpactScreen() {
  const { user } = useUser();
  ...
  const loadImpactData = async () => {
    try {
      ...
      const volunteerImpact = await mockData.getVolunteerImpact(volunteerId);
      setImpact(volunteerImpact);
      ...
      >
        ...
        <View style={styles.impactContainer}>
          <ImpactCard
            ...
            value={impact.totalDeliveries}
            icon="bicycle-outline"
            color="#FF9800"
            subtitle="Total deliveries made"
          />
          ...
          <ImpactCard
            ...
            icon="people-outline"
            color="#2196F3"
            subtitle="Estimated servings delivered"
          />
        ...
        <View style={styles.globalSection}>
          ...
          <View style={styles.globalStats}>
            ...
            <View style={styles.globalStatItem}>
              ...
              <Text style={styles.globalStatValue}>{globalImpact.totalDeliveries}</Text>
              <Text style={styles.globalStatLabel}>Deliveries</Text>
            </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              <Text style={styles.infoTitle}>Volunteer Impact</Text>
              <Text style={styles.infoText}>
                As a volunteer, you're the vital link connecting surplus food to those who need it most. Your deliveries help reduce food waste and feed the community.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoText}>
                Each delivery you make helps prevent food waste from ending up in landfills, reducing methane emissions and conserving the resources used to produce that food.
              </Text>
            </View>
          </View>
        </View>
