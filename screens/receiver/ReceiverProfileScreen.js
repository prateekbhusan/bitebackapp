...
export default function ReceiverProfileScreen({ navigation }) {
  ...
  const loadProfile = async () => {
    try {
      ...
      const userData = await mockData.getUserById(receiverId);
      setProfile(userData);
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          ...
          <Text style={styles.role}>Food Receiver</Text>
          
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{profile.totalReceived || 0}</Text>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{profile.mealsSaved || 0}</Text>
